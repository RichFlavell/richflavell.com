...
export type ArticleQuery = { mdx: Maybe<(Pick<Mdx, 'id' | 'body'> & { frontmatter: Maybe<(Pick<MdxFrontmatter, 'title' | 'customHeading'> & { images: Maybe<Array<Maybe<(Pick<File, 'publicURL'> & { childImageSharp: Maybe<{ fluid: Maybe<GatsbyImageSharpFluid_TracedSvgFragment> }> })>>>, featuredImage: Maybe<(Pick<File, 'publicURL'> & { childImageSharp: Maybe<{ fluid: Maybe<GatsbyImageSharpFluidFragment> }> })> })> })> };
